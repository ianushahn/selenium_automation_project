...
public class S_6055_openMyWishlistpage_click_on_mywishlistTab_fromHomePage implements AutmationConstants {
...
//		}
		...
		String expectedWishlistpageTitle = ExcelData.getData("MyWishList page", 0, 0);
		AllVerification.verifyTitle(expectedWishlistpageTitle , driver);
