...
public class S_6680_open_signin_page_clickon_Signin_Text_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(2000);
		// click on Signin Text from the header. 
		WebElement  SigninText = driver.findElement(By.cssSelector("span.text-sm.text-gray-700.font-medium"));
		Thread.sleep(4000);
		 SigninText.click();
		
		Thread.sleep(2000);
		System.out.println("fetching title after clicking on  Signin Text");
		...
		String expectedSignInPageTitle = ExcelData.getData("Signin text", 0, 0);
