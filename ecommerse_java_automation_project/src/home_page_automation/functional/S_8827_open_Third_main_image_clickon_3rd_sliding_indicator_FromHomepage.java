...
public class S_8827_open_Third_main_image_clickon_3rd_sliding_indicator_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(2000);
		// click on Third sliding indicator from the main image of hero section 
		WebElement ThirdSlidingIndicator = driver.findElement(By.cssSelector("div.carousel-indicators>button.active"));
		Thread.sleep(2000);
		ThirdSlidingIndicator.click();
		
		Thread.sleep(5000);
		System.out.println("fetcing title after clicking on ThirdSliding Indicator");
