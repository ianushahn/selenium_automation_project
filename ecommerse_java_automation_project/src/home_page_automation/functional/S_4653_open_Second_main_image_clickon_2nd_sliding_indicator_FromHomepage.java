...
public class S_4653_open_Second_main_image_clickon_2nd_sliding_indicator_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(1000);
		// click on Second sliding indicator from the main image of hero section 
		WebElement SecondSlidingIndicator = driver.findElement(By.cssSelector("div.carousel-indicators>button.active"));
		Thread.sleep(1000);
		SecondSlidingIndicator.click();
		
		Thread.sleep(1000);
		System.out.println("fetcing title after clicking on Second Sliding Indicator");
