...
public class S_4706_click_on_products_fromExploreOurCategory_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		WebElement ElectronicGadgest = driver.findElement(By.cssSelector("div.flex>div.rounded-lg:first-child"));
		Thread.sleep(2000);
		 ElectronicGadgest.click();
		
		Thread.sleep(2000);
		System.out.println("fetcing title after clicking on  ElectronicGadgest Category");
