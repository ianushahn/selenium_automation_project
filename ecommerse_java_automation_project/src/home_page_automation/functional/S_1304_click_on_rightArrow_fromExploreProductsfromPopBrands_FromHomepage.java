...
public class S_1304_click_on_rightArrow_fromExploreProductsfromPopBrands_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		WebElement  rightarrow  = driver.findElement(By.cssSelector("button.absolute.-right-4"));
		Thread.sleep(4000);
		 rightarrow  .click();
		
		Thread.sleep(4000);
		System.out.println("fetcing title after clicking on rightarrow  button");
