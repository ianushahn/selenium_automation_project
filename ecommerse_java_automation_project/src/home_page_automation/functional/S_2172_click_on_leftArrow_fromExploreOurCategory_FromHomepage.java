...
public class S_2172_click_on_leftArrow_fromExploreOurCategory_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		WebElement  leftarrow  = driver.findElement(By.cssSelector("div.relative>button.absolute.left-0"));
		Thread.sleep(4000);
		 leftarrow  .click();
