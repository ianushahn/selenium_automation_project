...
public class S_2283_click_on_contactUs_fromCompany_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(2000);
		System.out.println("fetcing title after clicking on  ContactUs link");
		
		
		String actual_ContactUs_page_title_afterclick = driver.getTitle(); 
		
		System.out.println(actual_ContactUs_page_title_afterclick);
		
		
		String expectedcontactUspageTitle = ExcelData.getData("contactus", 0, 0);
		
		
		if( expectedcontactUspageTitle .equals(actual_ContactUs_page_title_afterclick ))
		{
