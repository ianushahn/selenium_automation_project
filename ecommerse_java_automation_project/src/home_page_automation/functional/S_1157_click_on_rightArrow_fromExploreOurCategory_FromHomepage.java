...
public class S_1157_click_on_rightArrow_fromExploreOurCategory_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(2000);
		// click on right arrow from explore our category section 
		WebElement  rightarrow  = driver.findElement(By.cssSelector("div.relative>button.absolute.right-0"));
		Thread.sleep(2000);
		rightarrow .click();
		
		Thread.sleep(2000);
		System.out.println("fetcing title after clicking on  rightarrow Category");
