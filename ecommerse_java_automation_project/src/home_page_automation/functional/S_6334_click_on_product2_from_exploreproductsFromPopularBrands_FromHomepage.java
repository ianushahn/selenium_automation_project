...
public class S_6334_click_on_product2_from_exploreproductsFromPopularBrands_FromHomepage implements AutmationConstants {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		WebElement sheets  = driver.findElement(By.xpath("(//div[@class='min-w-[220px] border p-3 rounded shadow hover:shadow-md bg-white flex-shrink-0 cursor-pointer text-center'])[11]"));
		Thread.sleep(4000);
		sheets  .click();
		
		Thread.sleep(4000);
		System.out.println("fetcing title after clicking on sheets");
