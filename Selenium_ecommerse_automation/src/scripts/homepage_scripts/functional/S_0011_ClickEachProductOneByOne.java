...
public class S_0011_ClickEachProductOneByOne extends OpenClose
{
	...
	{
		openApplication();
		//scrolling to "Explore Products from Popular Brands" section
...
//clicking on each product
	 AllVerifications.clickIfVisibleAndEnabled(eachProduct, driver);  //navigating to single-product page 
	 Thread.sleep(3000);
...
//verify the heading of the product in single product page 
    ...
    AllVerifications.textIsPresentOrNot(expectedProductNameTextSingleProductPage, driver, expectedProductNameInSingleProductPage);
